...
ALL_BOARDS_DIR = 'boards/'
IMAGE_DIR = 'images/'
DAILY_BOARD_DIR = os.path.join(ALL_BOARDS_DIR, 'current/')
PAST_BOARDS_DIR = os.path.join(ALL_BOARDS_DIR, 'past/')
SKIN_NAMES_DIR = os.path.join(ALL_BOARDS_DIR, 'all_skins/')
